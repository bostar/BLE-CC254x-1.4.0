...
/* ZLG Zigbee Gpio defines */
  ...
  #define GPIO_ZM516X_RESET_TURN_HIGH()    st( GPIO_ZM516X_RESET_SBIT     = 1; )
  #define GPIO_ZM516X_DEF_TURN_HIGH()      st( GPIO_ZM516X_DEF_SBIT       = 1; )
  #define GPIO_ZM516X_WAKEUP_TURN_HIGH()   st( GPIO_ZM516X_WAKEUP_SBIT    = 1; )
  #define GPIO_ZM516X_SLEEP_TURN_HIGH()    st( GPIO_ZM516X_SLEEP_SBIT     = 1; )
  #define GPIO_ZM516X_MOTOR1_TURN_HIGH()   st( GPIO_ZM516X_MOTOR1_SBIT    = 1; )
  #define GPIO_ZM516X_MOTOR2_TURN_HIGH()   st( GPIO_ZM516X_MOTOR2_SBIT    = 1; )
  #define GPIO_ZM516X_MO_EN_TURN_HIGH()    st( GPIO_ZM516X_MO_EN_SBIT     = 1; )
  #define GPIO_ZM516X_PHASE_A_TURN_HIGH()  st( GPIO_ZM516X_PHASE_A_SBIT   = 1; )

  #define GPIO_ZM516X_RESET_TURN_LOW()     st( GPIO_ZM516X_RESET_SBIT     = 0; )
  #define GPIO_ZM516X_DEF_TURN_LOW()       st( GPIO_ZM516X_DEF_SBIT       = 0; )
  #define GPIO_ZM516X_WAKEUP_TURN_LOW()    st( GPIO_ZM516X_WAKEUP_SBIT    = 0; )
  #define GPIO_ZM516X_SLEEP_TURN_LOW()     st( GPIO_ZM516X_SLEEP_SBIT     = 0; )
  #define GPIO_ZM516X_MOTOR1_TURN_LOW()    st( GPIO_ZM516X_MOTOR1_SBIT    = 0; )
  #define GPIO_ZM516X_MOTOR2_TURN_LOW()    st( GPIO_ZM516X_MOTOR2_SBIT    = 0; )
  #define GPIO_ZM516X_MO_EN_TURN_LOW()     st( GPIO_ZM516X_MO_EN_SBIT     = 0; )
  #define GPIO_ZM516X_PHASE_A_TURN_LOW()   st( GPIO_ZM516X_PHASE_A_SBIT   = 0; )
#endif
