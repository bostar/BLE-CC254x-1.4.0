...
void HalKeyInit( void )
{
  ...
  PICTL |= (HAL_KEY_SW_1_EDGEBIT | HAL_KEY_SW_2_EDGEBIT | HAL_KEY_SW_3_EDGEBIT);   /* Set the edge bit to set falling edge to give int */
  HAL_KEY_SW_1_IEN |= ( HAL_KEY_SW_1_IENBIT | HAL_KEY_SW_2_IENBIT | HAL_KEY_SW_2_IENBIT);   /* enable CPU interrupt */
#endif
}
