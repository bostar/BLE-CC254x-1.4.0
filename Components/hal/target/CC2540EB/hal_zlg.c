...
//  GPIO_ZM516X_PHASE_A_TURN_LOW();
  ...
  HalGpioSet(GPIO_ZM516X_RESET_SBIT,1);
  HalGpioSet(GPIO_ZM516X_DEF_SBIT,1);
  HalGpioSet(GPIO_ZM516X_WAKEUP_SBIT,1);
  HalGpioSet(GPIO_ZM516X_SLEEP_SBIT,1);
  HalGpioSet(GPIO_ZM516X_MOTOR1_SBIT,0);
  HalGpioSet(GPIO_ZM516X_MOTOR2_SBIT,0);
  HalGpioSet(GPIO_ZM516X_MO_EN_SBIT,1);
  HalGpioSet(GPIO_ZM516X_PHASE_A_SBIT,1);
}
